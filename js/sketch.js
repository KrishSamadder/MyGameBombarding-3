...
function setup() {
  ...
  invisibleground=createSprite(682.5, 410, 1365, 5);
...
function draw() {
  ...
  textSize(12.5);
  fill("white");
  text("Press left and right arrow keys to collect the health drinks and health kits (to get scores) and avoid the viruses. Both the agents can slide as well as run. You have 2 lives. To win get a score of 10. Press on restart once your lives get exhausted.",  10, 13);
...
function spawnBombs(){
  ...
  if(frameCount%60===0){
    ...
    boom=createSprite(bomb.x, bomb.y+400, 0.1, 0.1);
boom.scale=0.1
boom.lifetime=60;
    bomb.scale=0.2;
